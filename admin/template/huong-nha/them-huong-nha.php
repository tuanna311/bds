<?php 
	...
	function huong_nha () {
		...
		if (isset($_POST['add_huongnha'])) {
			...
			$sql = "INSERT INTO huong_nha (name) VALUES ('$name')";
			$result = mysqli_query($conn_vn, $sql);
			if ($result) {
				echo '<script type="text/javascript">alert(\'Bạn đã thêm được một hướng nhà.\');window.location.href="index.php?page=huong-nha"</script>';
			} else {
