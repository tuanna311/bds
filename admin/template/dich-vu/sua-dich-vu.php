    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <p style="width:100%;margin-top:5px;">
                <textarea class="longtxtNCP1 ckeditor" id="editor2" style="height:50px;" name="service_des"><?= $row_showMain['lang_service_des']?></textarea>    
            </p>
            <p class="titleRightNCP">Nội dung :</p>
            ...
            <div class="rowNCP">
                ...
                <div class="subColContent">
                    ...
                    <input type="text" class="txtNCP1" value="<?= $row['service_views']?>" name="service_views"/>
                </div>
                <div class="subColContent">
                    <p class="titleRightNCP" >Lịch mở bán</p>
                    <input type="date" class="txtNCP1" value="<?= $row['service_update_date']?>" name="service_update_date"/>
                </div>
            </div>
            <div class="subColContent">
